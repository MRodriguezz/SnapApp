define({
  ...
  swipeTutorial:function() {
    ...
    if(contPositionScrollX <= 0) {
      ...
      this.setSkinDots("sknFlxIndicatorActive", "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive", 
                       "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive");
      ...
      this.setSkinDots("sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive",
                       "sknFlxIndicatorActive", "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive");
       // Title of the swipe tutorial header card
      ...
      this.setSkinDots("sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive",
                       "sknFlxIndicatorDesactive", "sknFlxIndicatorActive", "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive");
       // Title of the swipe tutorial header card
      this.view.lblTextSwipeTuto03.isVisible = false;
      ...
      this.setSkinDots("sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive",
                       "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive", "sknFlxIndicatorActive", "sknFlxIndicatorDesactive");
       // Title of the swipe tutorial header card
      ...
      this.setSkinDots("sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive",
                       "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive", "sknFlxIndicatorDesactive", "sknFlxIndicatorActive");
       // Title of the swipe tutorial header card
  ...
  **********************************************************************/
  setSkinDots:function(dotIndicator00, dotIndicator01, dotIndicator02, dotIndicator03, dotIndicator04, 
                        dotIndicator05, dotIndicator06, dotIndicator07, dotIndicator08) {
