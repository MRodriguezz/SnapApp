define({
    ...
    fetchCountyDirectoryData: function() {
        try {
            ...
            intgService.invokeOperation("countyDirectory", headerParams, inputparams, this.fetchCountyDirectorySuccessCallback, this.fetchCountyDirectoryErrorCallback);
        } catch (e) {
    ...
    SetDataForDirectory: function(countyDirectoryResult) {
        ...
        if (countyDirectoryResult.CountyDirectory !== null && countyDirectoryResult.CountyDirectory !== undefined && countyDirectoryResult.CountyDirectory !== "") {
            ...
            this.view.segDirectory.widgetDataMap = {
                lblHeaderDirectory: "lblHeaderDirectory",
                NameDirectory: "county",
                hours: "hours",
                address: "address",
                latitude: "latitude",
                phone2: "phone2",
                ...
                for (var i = 0; i < directorydata.length; i++) {
                    ...
                    if (segmentData.length !== 0) {
                        ...
                        if (matchingElementIndex !== "") {
                            ...
                            segmentData.push([{
                                    "lblHeaderDirectory": countyname.charAt(0)
                                },
                                [directorydata[i]]
                            ]);
                        }
